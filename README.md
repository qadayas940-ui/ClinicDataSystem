...
## رابط موحد عبر شبكات مختلفة

النسخة المحلية تستخدم رابط LAN يُكتشف تلقائياً ويُحفظ أيضاً في
`Clinic-Network-Link.txt` داخل مجلد البيانات. أما الرابط العام الثابت فيتطلب
خادماً مركزياً متصلاً بالإنترنت، PostgreSQL وHTTPS. بعد النشر اضبط:
