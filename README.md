...
هذه نسخة تجريبية عملية مدتها 30 يوماً. بعد الانتهاء تتحول إلى القراءة والتصدير فقط؛ لا تُحذف البيانات. واجهات التشغيل الأساسية، حسابات الموظفين، الأقسام، الاستيراد المرحلي، سجل التدقيق، النسخ الكامل، وتصدير Excel موجودة على الفرع `codex/v1-complete`.
...
الناتج في `release/ClinicDataSystem-Setup-1.0.0.exe`.
...
آخر تحقق: 23 اختباراً آلياً ناجحاً، بالإضافة إلى فحص محلي كامل لملف العمل الخاص دون رفعه أو نشر إحصاءاته.
