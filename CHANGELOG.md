...
- منع طلبات فتح بطاقة المريض المتكررة وإصلاح تداخل نماذج البطاقة والحذف.
- بحث Excel بحقل مدمج وقائمة نتائج مرئية وبطاقة في G:I بدون ماكرو.
- حفظ النصوص الحرة للقسم والطبيب والمنظّم والتشخيص في الزيارة، ولا تُضاف للقائمة إلا بطلب صريح.
- إلزام الأسماء الجديدة بثلاث وحدات مع احتساب «عبد الله» وأمثاله وحدة واحدة.
- بدء نافذة Windows بالعربية، وحفظ جلسة الجهاز حتى تحديث الإصدار أو تسجيل الخروج.
