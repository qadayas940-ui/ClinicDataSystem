...
- وحّد مسارات نافذة Windows على حفظ الجلسة وبدء الواجهة بالعربية، وأبقى الخادم المحلي متاحًا بعد إغلاق النافذة.
- قيّد تحميل سجل الزيارات والمصدر عند فتح قائمة المرضى والبطاقة لتفادي التعليق مع الملفات الكبيرة.
- أضاف إغلاقًا وإعادة محاولة عند تعذّر فتح البطاقة، مع إبقاء النموذج عند فشل حفظ مؤقت.
- جعل بطاقة Excel تظهر لأول نتيجة مطابقة تلقائيًا، مع اختيار النتائج الأخرى من القائمة والاحتفاظ بسجل الزيارات.
- صحّح تباين نص الترحيب في اللغتين وأجبر تحديث ملفات CSS/JS عند تغيير الإصدار.
